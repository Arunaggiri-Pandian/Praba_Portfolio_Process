    ...
    graduate: [
      {
        ...
        description: [
          ...
          '<strong>Manufacturing Insight:</strong> This project provided practical experience in mapping a logical design onto a physical architecture. Analyzing the post-synthesis trade-offs between different FSM encoding styles highlighted how high-level design choices directly impact physical resource utilization (LUTs vs. FFs) on the silicon.',
        ],
      ...
      },
      {
        ...
        description: [
          ...
          '<strong>Manufacturing Insight:</strong> This project provided critical insights into Design for Manufacturability (DFM), from analyzing the impact of process corner variations on yield to utilizing specific physical layout techniques (e.g., thick oxide devices) to mitigate device mismatch and process-induced noise.',
        ],
      ...
      },
      {
        ...
        description: [
          ...
          '<strong>Manufacturing Insight:</strong> This project involved analyzing the process-level challenges of integrating custom logic into a dense memory array at the 130nm node, including evaluating the physical area impact (0.4% overhead) and its effect on the manufacturability and reliability of the surrounding memory cells.',
        ],
      ...
      },
      {
        ...
        description: [
          ...
          '<strong>Manufacturing Insight:</strong> Designing to a standard like AXI4-Lite is a core principle of Design for Manufacturability (DFM), as it ensures that IP blocks can be reliably integrated into a larger SoC. Rigorous verification of this interface is critical to preventing costly manufacturing spins due to integration failures.',
        ],
