...
const Projects: React.FC<ProjectsProps> = ({ projects }) => (
    <section className="animate-fade-in space-y-6">
        {projects.map((project, index) => (
            <div key={index} className="p-6 bg-light-card dark:bg-dark-card rounded-lg shadow-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-light-accent/40 dark:hover:shadow-dark-accent/20">
