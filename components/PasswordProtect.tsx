...
const PasswordProtect: React.FC<PasswordProtectProps> = ({ onAuthenticate, isDarkMode, toggleTheme }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-light-bg dark:bg-dark-bg transition-colors duration-300">
      ...
      <div className="w-full max-w-md p-8 space-y-6 bg-light-card dark:bg-dark-card rounded-2xl shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full py-3 font-semibold text-white bg-light-accent dark:bg-dark-accent rounded-lg hover:bg-blue-600 dark:hover:bg-teal-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-light-accent dark:focus:ring-dark-accent transition-all duration-300 shadow-lg"
          >
            Unlock
          </button>
        </form>
